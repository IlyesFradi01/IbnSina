          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Founded in 2010, IBN SINA began as a small family business with a simple mission: 
                  to make authentic, high-quality medicinal herbs accessible to everyone. Named after 
                  the great Persian physician and philosopher Avicenna (Ibn Sina), we honor the rich 
                  tradition of Islamic medicine while embracing modern quality standards.
                </p>
                <p>
                  What started as a passion for natural healing has grown into a trusted source for 
                  thousands of customers worldwide. We work directly with farmers and suppliers across 
                  the Middle East, North Africa, and Asia to bring you the purest, most effective 
                  medicinal herbs and organic products.
                </p>
                <p>
                  Today, we're proud to offer over 500 carefully curated products, from traditional 
                  herbs used for centuries to modern organic supplements, all backed by our 
                  commitment to quality, authenticity, and sustainability.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-green-100 flex items-center justify-center">
